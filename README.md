# Nick's Color Palette app

This Color Palette app takes hex values inputted by the user and makes them into buttons on the screen showing you what colors you are typing.

## Stretch Feature

There were no stretch features added
